...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (27, 7, 13),
        ('no_overrides', 2, True, False): (72, 7, 84),
        ('no_overrides', 3, True, False): (267, 7, 335),
        ('ccx', 1, True, False): (27, 7, 13),
        ('ccx', 2, True, False): (72, 7, 84),
        ('ccx', 3, True, False): (267, 7, 335),
        ('ccx', 1, True, True): (27, 7, 14),
        ('ccx', 2, True, True): (72, 7, 85),
        ('ccx', 3, True, True): (267, 7, 336),
        ('no_overrides', 1, False, False): (27, 7, 13),
        ('no_overrides', 2, False, False): (72, 7, 84),
        ('no_overrides', 3, False, False): (267, 7, 335),
        ('ccx', 1, False, False): (27, 7, 13),
        ('ccx', 2, False, False): (72, 7, 84),
        ('ccx', 3, False, False): (267, 7, 335),
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (27, 4, 9),
        ('no_overrides', 2, True, False): (72, 19, 54),
        ('no_overrides', 3, True, False): (267, 84, 215),
        ('ccx', 1, True, False): (27, 4, 9),
        ('ccx', 2, True, False): (72, 19, 54),
        ('ccx', 3, True, False): (267, 84, 215),
        ('ccx', 1, True, True): (29, 4, 13),
        ('ccx', 2, True, True): (74, 19, 84),
        ('ccx', 3, True, True): (269, 84, 335),
        ('no_overrides', 1, False, False): (27, 4, 9),
        ('no_overrides', 2, False, False): (72, 19, 54),
        ('no_overrides', 3, False, False): (267, 84, 215),
        ('ccx', 1, False, False): (27, 4, 9),
        ('ccx', 2, False, False): (72, 19, 54),
        ('ccx', 3, False, False): (267, 84, 215),
        ('ccx', 1, False, True): (27, 4, 9),
        ('ccx', 2, False, True): (72, 19, 54),
        ('ccx', 3, False, True): (267, 84, 215),
    }
