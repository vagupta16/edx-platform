...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QueriesTemporary'
        db.create_table('courseware_queriestemporary', (
        ...
        db.send_create_signal('courseware', ['QueriesStudents'])

        # Adding model 'GroupedQueriesSubqueries'
        db.create_table('courseware_groupedqueriessubqueries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Changing field 'CoursePreference.course_id'
        db.alter_column('courseware_coursepreference', 'course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CoursePreference.course_id'
        db.alter_column('courseware_coursepreference', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'courseware.groupedqueries': {
            'Meta': {'object_name': 'GroupedQueries'},
            'course_id': ('xmodule_django.models.CourseKeyField', [], {'max_length': '255', 'db_index': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'courseware.groupedqueriessubqueries': {
            'Meta': {'object_name': 'GroupedQueriesSubqueries'},
        ...
        'courseware.queriessaved': {
            'Meta': {'object_name': 'QueriesSaved'},
            'course_id': ('xmodule_django.models.CourseKeyField', [], {'max_length': '255', 'db_index': 'True'}),
