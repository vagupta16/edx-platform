...
urlpatterns = patterns('',  # nopep8
    ...
    url(r'^get_filtered_students$',
        'instructor.views.api.get_filtered_students', name="get_filtered_students"),
    url(r'^get_filtered_students/(?P<inclusion>\S{2,3})/(?P<queryType>(Section|Problem))/(?P<stateType>\S+)/(?P<stateId>\S+)$',
        'instructor.views.api.get_filtered_students', name="get_filtered_students"),
