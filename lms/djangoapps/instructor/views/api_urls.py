...
urlpatterns = patterns('',  # nopep8
    ...
    url(r'^get_total_students(?P<csv>/csv)?$',
        'instructor.views.api.get_total_students', name="get_total_students"),
    url(r'^save_query$',
    ...
    url(r'^get_single_query/(?P<inclusion>\S{2,3})/(?P<queryType>(Section|Problem))/(?P<stateType>\S+)/(?P<stateId>\S+)$',
        'instructor.views.api.get_single_query', name="get_single_query"),
    url(r'^get_single_query',
        'instructor.views.api.get_single_query', name="get_single_query"),
    url(r'^delete_saved_query/(?P<queryToDelete>\d+)$',
    ...
    url(r'^get_student_submissions$',
        'instructor.views.api.get_student_submissions', name="get_student_submissions"),
