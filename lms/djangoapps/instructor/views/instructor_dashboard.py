...
def _section_data_download(course, access):
    ...
    section_data = {
        ...
        'get_student_submissions_url': reverse('get_student_submissions', kwargs={'course_id': course_key.to_deprecated_string()}),
...
def _section_send_email(course, access):
    ...
    query_options = tuple((query.id, query.title if query.title else u'Query saved at ' + query.created.strftime("%m-%d-%y %H:%M")) for query in queries)
