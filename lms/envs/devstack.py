...
FEATURES['ENABLE_MAX_FAILED_LOGIN_ATTEMPTS'] = True #cl debug improve_account_lockout_messaging
MAX_FAILED_LOGIN_ATTEMPTS_LOCKOUT_PERIOD_SECS = 15 #cl debug improve_account_lockout_messagingg
